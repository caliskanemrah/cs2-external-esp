...
void CGame::loop() {
    ...
    while (true) {
        ...
        */
        ...
        // Read entity controller from the player pawn - Güncellenmiþ kýsým
        ...
        uintptr_t controller = process->read<uintptr_t>(controllerListSegment + 112 * entry); // 120 yerine 112
